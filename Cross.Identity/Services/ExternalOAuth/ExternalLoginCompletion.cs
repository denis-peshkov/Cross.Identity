...
/// </summary>
/// <param name="UserAccountId">Local user account id resolved or created during the OAuth callback.</param>
...
/// </param>
internal sealed record ExternalLoginCompletion(Guid UserAccountId, bool IsLinking);
