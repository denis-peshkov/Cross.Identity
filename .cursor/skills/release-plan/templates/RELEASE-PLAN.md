...
> При перепроверке / dismiss: **сначала** `## Закрыто` как `| ✅ H2 Short title | … |` (или `✅ #34 …`), **потом** убрать из open-секций этого плана и/или из `docs/TO-DO.md`. Нельзя только выкинуть.  
